namespace FastCarSales.Services.Data.Tests
{
    ...
    public class PostsServiceTests
    {
        ...
        public void CreateWithPublicPostShouldCreateANewPublicPostAndSaveItInTheDatabase()
        {
            ...
            Assert.Equal(testCar.CarModel, createdPost.Car.CarModel);
        }
        ...
        public void UpdateWithValidInputModelShouldUpdateThePostCorrectly()
        {
            ...
            //Act
            postsService.UpdateAsync(updatedPost, isPublic).GetAwaiter().GetResult();
        ...
        public void UpdateWithInvalidPostIdShouldThrowAnExcpetion()
        {
            ...
            //updatedPost.PostID = wrongId;

            //Act
            var exception = Record.Exception(() => postsService.UpdateAsync(updatedPost, isPublic).GetAwaiter().GetResult());
        ...
        public void GetBasicPostInformationByIdShouldReturnCorrectModel()
        {
            ...
            Assert.Equal(testPost.Car.Make.Name, result.Car.Make);
            Assert.Equal(testPost.Car.CarModel, result.Car.CarModel);
