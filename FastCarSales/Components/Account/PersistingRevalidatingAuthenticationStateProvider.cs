...
namespace FastCarSales.Components.Account
{
	...
	internal sealed class PersistingRevalidatingAuthenticationStateProvider : RevalidatingServerAuthenticationStateProvider
	{
		...
		{
			var claimsPrincipal = CreateIdentityFromUser().GetAwaiter().GetResult();

			if (claimsPrincipal != null)
			{
				task = Task.FromResult(new AuthenticationState(claimsPrincipal));
			}

			authenticationStateTask = task;
		}

        private async Task<ClaimsPrincipal?> CreateIdentityFromUser()
        {
